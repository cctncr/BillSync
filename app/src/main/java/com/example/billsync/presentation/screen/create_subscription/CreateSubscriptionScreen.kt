package com.example.billsync.presentation.screen.create_subscription
...
import com.example.billsync.presentation.preview.CreateSubscriptionPreviewProvider
...
fun CreateSubscriptionScreen(
    viewModel: CreateSubscriptionViewModel = hiltViewModel(),
    onNavigateBack: () -> Unit
) {
...
private fun CreateSubscriptionContent(
    ...
    uiState: CreateSubscriptionUiState,
    onNavigateBack: () -> Unit,
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text(stringResource(R.string.new_subscription_title)) },
                navigationIcon = {
...
@Composable
private fun CreateSubscriptionContent_Preview(
    @PreviewParameter(CreateSubscriptionPreviewProvider::class) uiState: CreateSubscriptionUiState
) {
    CreateSubscriptionContent(
        uiState = uiState,
        onNavigateBack = {},
